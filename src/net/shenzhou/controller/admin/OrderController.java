...
public class OrderController extends BaseController {
	...
	public String update(Order order, Long areaId, Long paymentMethodId, Long shippingMethodId, RedirectAttributes redirectAttributes) {
		...
		for (OrderItem orderItem : order.getOrderItems()) {
			if (orderItem.getId() != null) {
				...
				orderItem.setWeight(Double.valueOf(product.getWeight().toString()));
	...
	public String list(OrderStatus orderStatus, PaymentStatus paymentStatus, ShippingStatus shippingStatus,ServeState serveState, Boolean hasExpired, Pageable pageable, ModelMap model) {
		model.addAttribute("orderStatus", orderStatus);
		model.addAttribute("paymentStatus", paymentStatus);
		model.addAttribute("shippingStatus", shippingStatus);
		model.addAttribute("serveState", serveState);
		model.addAttribute("hasExpired", hasExpired);
		model.addAttribute("page", orderService.findPage(orderStatus, paymentStatus, shippingStatus,serveState, hasExpired, pageable));
