 ...
 */
package net.shenzhou.interceptor;
...
public class DoctorInterceptor extends HandlerInterceptorAdapter {
	...
	/** "会员"属性名称 */
	private static final String USER_ATTRIBUTE_NAME = "doctor";

	/** 默认登录URL */
	private static final String DEFAULT_LOGIN_URL = "/mechanismLogin/index.jhtml";
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		Principal principal = (Principal) session.getAttribute(Doctor.PRINCIPAL_ATTRIBUTE_NAME);
		if (principal != null) {
			return true;
		} else {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
		if (modelAndView != null) {
			...
			if (!StringUtils.startsWith(viewName, REDIRECT_VIEW_NAME_PREFIX)) {
				modelAndView.addObject(USER_ATTRIBUTE_NAME, doctorService.getCurrent());
			}
		}
	}
