...
public class Setting implements Serializable {
	...
	/** 保存验证码 add by wsr on  2018-3-8 10:21:28*/
...
//		user,
	...
	/** app安全密匙有效时间 */
	private Integer appSafeKeyExpiryTime;
	...
	/** 积分获取说明 **/
	private String poingExplain;
	
	/**医师邀请患者邀请者首次获得积分(医师邀请患者)**/
	private Long firstDoctorInvitationMemberPoint; 
	
	/**医师邀请患者邀请者二次获得积分(医师邀请患者)**/
	private Long secondaryDoctorInvitationMemberPoint; 
	
	/**被邀请着(医师邀请患者)**/
	private Long doctorInvitationMemberPoint; 
	
	/**医生邀请患者积分说明**/
	private String doctorInvitationMemberPointExplain; 
	
	/**医生积分有效期**/
	private Integer doctorPointDay;
	
	/**用户邀请用户邀请者首次获得积分(用户邀请用户)**/
	private Long firstMemberInvitationMemberPoint; 
	
	/**用户邀请患者邀请者二次获得积分(用户邀请用户)**/
	private Long secondaryMemberInvitationMemberPoint; 
	
	/**被邀请着(用户邀请用户)**/
	private Long memberInvitationMemberPoint; 
	
	/**患者邀请患者积分说明**/
	private String memberInvitationMemberPointExplain;
	
	/**用户积分有效期**/
	private Integer memberPointDay;
	...
	/**支付宝APP_PRIVATE_KEY(私钥)**/
	private String zfbAppPrivateKey;
	
	/**支付宝ALIPAY_PUBLIC_KEY(公钥)**/
	private String zfbAlipaypublicKey;
	
	/**支付宝AES秘钥(秘钥)**/
	private String zfbAesKey;
	...
	public PointGrantType getPointGrantType() {
		return pointGrantType;
	}

	public void setPointGrantType(PointGrantType pointGrantType) {
	...
	@NotNull
	@Min(0)
	public Integer getAppSafeKeyExpiryTime() {
		return appSafeKeyExpiryTime;
	}

	public void setAppSafeKeyExpiryTime(Integer appSafeKeyExpiryTime) {
		this.appSafeKeyExpiryTime = appSafeKeyExpiryTime;
	}
	...
	public String getPoingExplain() {
		return poingExplain;
	}

	public void setPoingExplain(String poingExplain) {
		this.poingExplain = poingExplain;
	}

	public Long getFirstDoctorInvitationMemberPoint() {
		return firstDoctorInvitationMemberPoint;
	}

	public void setFirstDoctorInvitationMemberPoint(
			Long firstDoctorInvitationMemberPoint) {
		this.firstDoctorInvitationMemberPoint = firstDoctorInvitationMemberPoint;
	}

	public String getDoctorInvitationMemberPointExplain() {
		return doctorInvitationMemberPointExplain;
	}

	public void setDoctorInvitationMemberPointExplain(
			String doctorInvitationMemberPointExplain) {
		this.doctorInvitationMemberPointExplain = doctorInvitationMemberPointExplain;
	}

	@NotNull
	@Min(1)
	public Integer getDoctorPointDay() {
		return doctorPointDay;
	}

	public void setDoctorPointDay(Integer doctorPointDay) {
		this.doctorPointDay = doctorPointDay;
	}

	public Long getSecondaryDoctorInvitationMemberPoint() {
		return secondaryDoctorInvitationMemberPoint;
	}

	public void setSecondaryDoctorInvitationMemberPoint(
			Long secondaryDoctorInvitationMemberPoint) {
		this.secondaryDoctorInvitationMemberPoint = secondaryDoctorInvitationMemberPoint;
	}

	public Long getDoctorInvitationMemberPoint() {
		return doctorInvitationMemberPoint;
	}

	public void setDoctorInvitationMemberPoint(Long doctorInvitationMemberPoint) {
		this.doctorInvitationMemberPoint = doctorInvitationMemberPoint;
	}

	public Long getFirstMemberInvitationMemberPoint() {
		return firstMemberInvitationMemberPoint;
	}

	public void setFirstMemberInvitationMemberPoint(
			Long firstMemberInvitationMemberPoint) {
		this.firstMemberInvitationMemberPoint = firstMemberInvitationMemberPoint;
	}

	public String getMemberInvitationMemberPointExplain() {
		return memberInvitationMemberPointExplain;
	}

	public void setMemberInvitationMemberPointExplain(
			String memberInvitationMemberPointExplain) {
		this.memberInvitationMemberPointExplain = memberInvitationMemberPointExplain;
	}

	@NotNull
	@Min(1)
	public Integer getMemberPointDay() {
		return memberPointDay;
	}

	public void setMemberPointDay(Integer memberPointDay) {
		this.memberPointDay = memberPointDay;
	}

	public Long getSecondaryMemberInvitationMemberPoint() {
		return secondaryMemberInvitationMemberPoint;
	}

	public void setSecondaryMemberInvitationMemberPoint(
			Long secondaryMemberInvitationMemberPoint) {
		this.secondaryMemberInvitationMemberPoint = secondaryMemberInvitationMemberPoint;
	}

	public Long getMemberInvitationMemberPoint() {
		return memberInvitationMemberPoint;
	}

	public void setMemberInvitationMemberPoint(Long memberInvitationMemberPoint) {
		this.memberInvitationMemberPoint = memberInvitationMemberPoint;
	}
	...
	public String getZfbAppPrivateKey() {
		return zfbAppPrivateKey;
	}

	public void setZfbAppPrivateKey(String zfbAppPrivateKey) {
		this.zfbAppPrivateKey = zfbAppPrivateKey;
	}
	...
	public String getZfbAesKey() {
		return zfbAesKey;
	}

	public void setZfbAesKey(String zfbAesKey) {
		this.zfbAesKey = zfbAesKey;
	}
