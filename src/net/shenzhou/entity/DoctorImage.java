...
@Embeddable
public class DoctorImage implements Serializable, Comparable<DoctorImage> {
	 ...
	 * @return 比较结果
	 */
	public int compareTo(DoctorImage doctorImage) {
		return new CompareToBuilder().append(getOrder(), doctorImage.getOrder()).toComparison();
	}
