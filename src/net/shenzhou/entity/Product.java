...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/shenzhou/template[@id='productContent']");
	...
	public boolean isSalesMethod() {
		return salesMethod;
	}

	public void setSalesMethod(boolean salesMethod) {
