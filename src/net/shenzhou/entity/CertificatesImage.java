 ...
 */
@Embeddable
public class CertificatesImage implements Serializable, Comparable<CertificatesImage> {

	
	private static final long serialVersionUID = -5172324042545931972L;
	 ...
	 * @return 比较结果
	 */
	public int compareTo(CertificatesImage productImage) {
