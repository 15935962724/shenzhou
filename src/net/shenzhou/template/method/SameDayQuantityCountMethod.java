 ...
 *
 */
@Component("sameDayQuantityCountMethod")
public class SameDayQuantityCountMethod implements TemplateMethodModel {
	...
	public Object exec(List arguments) throws TemplateModelException {
		if (arguments != null && !arguments.isEmpty() && arguments.get(0) != null&& arguments.get(1) != null) {
			return getSameDayQuantityCount(arguments.get(0),arguments.get(1));
		}
		return 0;
	}
	 ...
	 * @return
	 */
	private Double getSameDayQuantityCount(Object doctorId,Object date) {
		Double count = 0.0;
		if (doctorId != null &&date!=null) {
			...
			count = orderService.getSameDayQuantityCount(query_map);
			return count;
		} 
		return count;
	}
