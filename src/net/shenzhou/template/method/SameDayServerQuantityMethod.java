 ...
 *
 */
@Component("sameDayServerQuantityMethod")
public class SameDayServerQuantityMethod implements TemplateMethodModel {
	...
	public Object exec(List arguments) throws TemplateModelException {
		if (arguments != null && !arguments.isEmpty() && arguments.get(0) != null&& arguments.get(1) != null) {
			return getSameDayServerQuantity(arguments.get(0),arguments.get(1));
		}
		return 0;
	}
	 ...
	 * @return
	 */
	private Double getSameDayServerQuantity(Object doctorId,Object date) {
		Double count = 0.0;
		if (doctorId != null &&date!=null) {
			...
			count = orderService.getSameDayServerQuantity(query_map);
			return count;
		} 
		return count;
	}
