 ...
 *
 */
@Component("sameDayOrderCountMethod")
public class SameDayOrderCountMethod implements TemplateMethodModel {
	...
	public Object exec(List arguments) throws TemplateModelException {
		if (arguments != null && !arguments.isEmpty() && arguments.get(0) != null&& arguments.get(1) != null) {
			return getSameDayOrderCount(arguments.get(0),arguments.get(1));
		}
		return 0;
	}
	 ...
	 * @return
	 */
	private Integer getSameDayOrderCount(Object doctorId,Object date) {
		Integer count = 0;
		if (doctorId != null &&date!=null) {
			...
			count = orderService.getSameDayOrderCount(query_map);
			return count;
		} 
		return count;
	}
