 ...
 * @version 1.0
 */
@Component("journalismCategoryChildrenListDirective")
public class JournalismCategoryChildrenListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if (journalismCategoryId != null && journalismCategory == null) {
			...
			if (useCache) {
				journalismCategories = journalismCategoryService.findChildren(journalismCategory, count, cacheRegion);
			} else {
				journalismCategories = journalismCategoryService.findChildren(journalismCategory, count);
			}
		}
