...
<%@page import="net.shenzhou.Setting"%>
<%@page import="net.shenzhou.util.SettingUtils"%>
<%@page import="net.shenzhou.util.SpringUtils"%>
<%@page import="net.shenzhou.Setting.CaptchaType"%>
<%@page import="net.shenzhou.Setting.AccountLockType"%>
<%@page import="net.shenzhou.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By HaoKangHu</title>
...
<body>
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="hkh_logn.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif" alt="HaoKangHu" />
						</td>
						<th>
