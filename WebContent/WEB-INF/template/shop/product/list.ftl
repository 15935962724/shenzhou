...
[#if productCategory??]
	[@seo type = "productList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered] - Powered By HaoKangHu[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.product.title")}[#if systemShowPowered] - Powered By HaoKangHu[/#if]</title>
	<meta name="author" content="HaoKangHu Team" />
	<meta name="copyright" content="HaoKangHu" />
[/#if]
