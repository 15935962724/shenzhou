...
<form id="inputForm" action="${base}/web/member/editPatientData.jhtml" method="POST" enctype="multipart/form-data">
<input type="hidden" name="nowAreaId" id="nowAreaId" value="">
<input type="hidden" name="regAreaId" id="regAreaId" value="">
<input type="hidden" name="img" id="img" value="${member.logo}">
<input type="hidden" name="patientId" id="patientId" value="${member.id}">
     <div id="header" class="pf h329" style="border-bottom:#f0f1f0 1px solid;">
     	<div id="back" align="left" style="width: 2rem;float:left;margin-left:0.5rem;"><a href="${base}/web/member/toMyself.jhtml"><img alt="" src="${base}/resources/web/images/backBtnImg.png" style="width:0.59rem; height:auto" class="backImg"></a></div>
     ...
     <div class="myCenter_information">
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div style="top:0px; margin-left: 15rem;" class="myCenter_information_topImg"><img src="${member.logo}"  id="up_img" style="border-radius: 1rem;width: 2rem; height: 2rem;" onclick="preview_img('upfile','up_img','1');" ><input id="upfile" name="upfile" type="file" style="display: none"/></div>
     	 </div>
     	 
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 <div class="myCenter_information_leftName">真实姓名</div>
     	 	 <div class="myCenter_information_rightInput">
     	 	     <input type="text" name="realName" id="realName" size="15" placeholder="请输入真实姓名" value="${member.name}" class="myCenter_information_input" style="font-size:1rem;">
     	 	 </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_sex">
     	 	    <input type="radio" id="sex" name="sex" value="male" class="myCenter_information_sexStyle" [#if member.gender=="male"] checked="true" [/#if]> 男
     	 	    <input type="radio" id="sex" name="sex" value="female" class="myCenter_information_sexNv myCenter_information_sexStyle" [#if member.gender=="female"] checked="true" [/#if]> 女
     	 	 </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_rightInput">
     	 	      <input type="text" name="nation" id="nation" size="15" value="${member.nation}"  class="myCenter_information_input" style="font-size:1rem;">
     	 	 </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_birthStyle">
     	 	     <input type="text" name="birthDay" id="birthDay" value="${member.birth?string("yyyy-MM-dd")}" class="myCenter_information_birth_input" style="font-size:1rem;">
     	 	 </div>
     	 	 <div class="myCenter_information_calendar">
     	 	    ...
     	 	    <select id="calendar" name="calendar" class="myCenter_information_calendarInput myCenter_caleder_select" style="line-height: 1.3rem;">
     	 	    	<option value="cregorian" [#if member.calendar=="cregorian"] checked="true" [/#if] >阳历</option>
     	 	    	<option value="lunar"[#if member.calendar=="lunar"] checked="true" [/#if] >阴历</option>
     	 	    </select>
     	 	 </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_selectClass myCenter_information_input">
    	 	     <select id="reg_province" name="reg_province" class="w5 h15 z_106_909090_1" onChange="setSelect($('#reg_province').val(),'regcityinfo','city|reg');">
    	 	     	<option>${member.area.fullName}</option>
     	 ...
     	 <div class="myCenter_information_inputStyle" style="border-bottom:#f0f1f0 1px solid;">
     	 	  <div class="myCenter_information_rightInputs">
     	 	       <textarea name="householdAddress" id="householdAddress" style="width:100%;height:4rem;font-size:1rem;color:#323232;" class="testarea_style">${member.areaAddress}</textarea>
     	 	  </div>
     	 </div>
     	  ...
     	  <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_selectClass myCenter_information_input">
    	 	     <select id="now_province" name="now_province" class="w5 h15 z_106_909090_1" onChange="setSelect($('#now_province').val(),'nowcityinfo','city|now');">
    	 	     	<option>${member.nowArea.fullName}</option>
    	 	     	[#list top_area as province]
    	 	     		<option value="${province.id}">${province.name}</option>
    	 	     	[/#list]
    	 	     </select>
     	 ...
     	 <div class="myCenter_information_inputStyle" style="border-bottom:#f0f1f0 1px solid;">
     	 	  <div class="myCenter_information_rightInputs">
     	 	     <textarea name="address" id="address" style="width:100%;height:4rem;font-size:1rem;color:#323232;" class="testarea_style">${member.address}</textarea>
     	 	  </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_rightInput">
     	 	     <input type="text" name="memberIphone" value="${member.phone}" id="memberIphone" size="15"  class="myCenter_information_input" style="font-size:1rem;">
     	 	 </div>
     	 </div>
     	 ...
     	 <div class="myCenter_information_style" style="border-bottom:#f0f1f0 1px solid;">
     	 	 ...
     	 	 <div class="myCenter_information_rightInput">
     	 	     <input type="text" name="healthCard" id="healthCard" size="15" value="${member.medicalInsuranceId}" class="myCenter_information_input" style="font-size:1rem;">
     	 	 </div>
     	 </div>
