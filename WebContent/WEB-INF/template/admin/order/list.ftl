	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="mode">服务方式</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="serveState">服务状态</a>
				</th>
				<th>
			...
			[#list page.content as order]
				<tr>
					...
					<td>
						${message("Project.Mode."+order.mode)}
					</td>
					<td>
					...
					<td>
						${message("Order.ServeState." + order.serveState)}
					</td>
					<td>
