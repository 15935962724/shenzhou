...
<title>${message("admin.role.edit")} - Powered By HaoKangHu</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:patient"[#if role.authorities?seq_contains("admin:patient")] checked="checked"[/#if] />患者管理
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:feedback"[#if role.authorities?seq_contains("admin:feedback")] checked="checked"[/#if] />${message("admin.role.feedback")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:memberPointLog"[#if role.authorities?seq_contains("admin:memberPointLog")] checked="checked"[/#if] />${message("admin.role.memberPointLog")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rechargeLog"[#if role.authorities?seq_contains("admin:rechargeLog")] checked="checked"[/#if] />${message("admin.role.rechargeLog")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:platformRechargeLog"[#if role.authorities?seq_contains("admin:platformRechargeLog")] checked="checked"[/#if] />${message("admin.role.memberPointLog")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.main.mechanism")}">${message("admin.main.mechanism")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism"[#if role.authorities?seq_contains("admin:mechanism")] checked="checked"[/#if] />机构管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctor"[#if role.authorities?seq_contains("admin:doctor")] checked="checked"[/#if] />医生管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctor_category"[#if role.authorities?seq_contains("admin:doctor_category")] checked="checked"[/#if] />医生职称管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism_category"[#if role.authorities?seq_contains("admin:mechanism_category")] checked="checked"[/#if] />机构类型管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism_rank"[#if role.authorities?seq_contains("admin:mechanism_rank")] checked="checked"[/#if] />机构等级管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:server_project_category"[#if role.authorities?seq_contains("admin:server_project_category")] checked="checked"[/#if] />项目类型管理
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.main.webIndex")}">${message("admin.main.webIndex")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:journalism"[#if role.authorities?seq_contains("admin:journalism")] checked="checked"[/#if] />新闻管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:journalismCategory"[#if role.authorities?seq_contains("admin:journalismCategory")] checked="checked"[/#if] />新闻分类管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:expert"[#if role.authorities?seq_contains("admin:expert")] checked="checked"[/#if] />专家团队
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctorRank"[#if role.authorities?seq_contains("admin:doctorRank")] checked="checked"[/#if] />专家等级
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:relationship"[#if role.authorities?seq_contains("admin:relationship")] checked="checked"[/#if] />${message("admin.role.relationship")}
						</label>
						<label>
