...
<title>${message("admin.role.add")} - Powered By HaoKangHu</title>
...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:feedback" />${message("admin.role.feedback")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:memberPointLog" />${message("用户积分")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rechargeLog" />${message("机构充值")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:platformRechargeLog" />${message("平台充值")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">机构设置</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism" />机构管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctor" />医生管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctor_category" />医生职称管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism_category" />机构类型管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:mechanism_rank" />机构等级管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:server_project_category" />项目类型管理
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">官网设置</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:journalism" />新闻管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:journalismCategory" />新闻分类管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:expert" />专家团队
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:doctorRank" />专家等级
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:relationship" />${message("admin.role.relationship")}
						</label>
						<label>
