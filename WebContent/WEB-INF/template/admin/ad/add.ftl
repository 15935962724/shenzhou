...
<title>${message("admin.ad.add")} - Powered By HaoKangHu</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr id="pathTr" class="hidden">
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="path" placeholder="建议上传750*300或等比例" name="path" class="text" maxlength="200" disabled="disabled" />
			...
			<tr>
				...
				<td>
					<textarea name ="remark" class="text" style="width:350px; height:120px;"></textarea>
				</td>
			</tr>
			<tr>
				<th>
