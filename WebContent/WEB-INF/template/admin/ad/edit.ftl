...
<title>${message("admin.ad.edit")} - Powered By HaoKangHu</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr id="pathTr"[#if ad.type == "text"] class="hidden"[/#if]>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="path" name="path" placeholder="建议上传750*300或等比例" class="text" value="${ad.path}" maxlength="200"[#if ad.type == "text"] disabled="disabled"[/#if] />
						<input type="button" id="browserButton" class="button" value="${message("admin.browser.select")}" /><a href= "${ad.path}" target="frame1">查看</a>
					</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea name ="remark" class="text" style="width:350px; height:120px;">${ad.remark}</textarea>
				</td>
			</tr>
			<tr>
				<th>
