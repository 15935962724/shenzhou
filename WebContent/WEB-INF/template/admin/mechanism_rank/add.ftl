...
<body>
	...
	<form id="inputForm" action="${base}/admin/mechanism_rank/save.jhtml" method="post">
		<table class="input">
			<tr>
				<th>
				...
				<td>
					<select name="parentId">
						...
						[#list mechanismRankTree as  mechanismRank]
							<option value="${mechanismRank.id}">
								[#if mechanismRank.grade != 0]
									[#list 1..mechanismRank.grade as i]
										&nbsp;&nbsp;
									[/#list]
								[/#if]
								${mechanismRank.name}
