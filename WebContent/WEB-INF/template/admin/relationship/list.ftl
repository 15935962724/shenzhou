...
<title>${message("admin.ad.list")} - Powered By HaoKangHu</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="title">关系</a>
				</th>
				<th>
			...
			[#list page.content as relationship]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${relationship.id}" />
					</td>
					<td>
						<span title="${relationship.title}">${abbreviate(relationship.title, 50, "...")}</span>
					</td>
					<td>
						${relationship.order}
					</td>
					<td>
						<a href="edit.jhtml?id=${relationship.id}">[编辑]</a>
					</td>
				</tr>
			[/#list]
		</table>
