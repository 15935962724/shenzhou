...
<title>${message("admin.main.title")} - Powered By HaoKangHu</title>
				...
				<div id="nav" class="nav">
					<ul>
						...
						[#list ["admin:order", "admin:payment", "admin:refunds", "admin:shipping", "admin:returns", "admin:deliveryCenter", "admin:deliveryTemplate"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:member","admin:patient","admin:memberRank", "admin:memberAttribute", "admin:review", "admin:consultation"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:navigation", "admin:article", "admin:articleCategory","admin:journalism","admin:journalismCategory","admin:expert","admin:doctorRank","admin:tag", "admin:friendLink", "admin:feedback", "admin:adPosition", "admin:ad", "admin:template", "admin:cache", "admin:static", "admin:index"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
						...
						[#list ["admin:promotion", "admin:coupon", "admin:seo", "admin:sitemap"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:comprehensive","admin:statistics", "admin:sales", "admin:salesRanking", "admin:purchaseRanking", "admin:deposit","admin:memberPointLog"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
						...
						[#list ["admin:mechanism", "admin:doctor","admin:doctor_category", "admin:mechanism_category", "admin:mechanism_rank", "admin:server_project_category"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
									<a href="#mechanism">${message("机构")}</a>
								</li>
								[#break /]
							[/@shiro.hasPermission]
						[/#list]
						
						[#list ["admin:setting", "admin:area","admin:relationship","admin:paymentMethod", "admin:shippingMethod", "admin:deliveryCorp", "admin:paymentPlugin", "admin:storagePlugin", "admin:admin", "admin:role", "admin:message", "admin:log"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
			...
			<td id="menu" class="menu">
				...
				<dl id="order">
					...
					[@shiro.hasPermission name="admin:shipping"]
						<dd>
							<a href="../productOrder/list.jhtml" target="iframe">${message("admin.role.productOrder")}</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="member">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:patient"]
						<dd>
							<a href="../patient/list.jhtml" target="iframe">患者管理</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="content">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:journalism"]
						<dd>
							<a href="../journalism/list.jhtml" target="iframe">新闻管理</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:journalismCategory"]
						<dd>
							<a href="../journalism_category/list.jhtml" target="iframe">新闻分类</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:expert"]
						<dd>
							<a href="../expert/list.jhtml" target="iframe">专家团队</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:doctorRank"]
						<dd>
							<a href="../doctorRank/list.jhtml" target="iframe">专家等级</a>
						</dd>
					[/@shiro.hasPermission]
					...
					[@shiro.hasPermission name="admin:feedback"]
						<dd>
							<a href="../feedback/list.jhtml" target="iframe">${message("admin.main.feedback")}</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="statistics">
					...
					[/@shiro.hasPermission]
					-->
					[@shiro.hasPermission name="admin:comprehensive"]
						<dd>
							<a href="../comprehensive/view.jhtml" target="iframe">综合统计</a>
						</dd>
					[/@shiro.hasPermission]
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:memberPointLog"]
						<dd>
							<a href="../memberPointLog/list.jhtml" target="iframe">${message("admin.main.memberPointLog")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:rechargeLog"]
						<dd>
							<a href="../rechargeLog/list.jhtml" target="iframe">${message("admin.main.rechargeLog")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:platformRechargeLog"]
						<dd>
							<a href="../platformRechargeLog/list.jhtml" target="iframe">${message("admin.main.platformRechargeLog")}</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				...
				<dl id="mechanism">
					<dt>${message("机构管理")}</dt>
					[@shiro.hasPermission name="admin:mechanism"]
						<dd>
							<a href="../mechanism/list.jhtml" target="iframe">机构管理</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:doctor"]
						<dd>
							<a href="../doctor/list.jhtml" target="iframe">医生管理</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:doctor_category"]
						<dd>
							<a href="../doctor_category/list.jhtml" target="iframe">医生职称</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:mechanism_category"]
						<dd>
							<a href="../mechanism_category/list.jhtml" target="iframe">机构类型</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:mechanism_rank"]
						<dd>
							<a href="../mechanism_rank/list.jhtml" target="iframe">机构等级</a>
						</dd>
					[/@shiro.hasPermission]
					
					[@shiro.hasPermission name="admin:server_project_category"]
						<dd>
							<a href="../server_project_category/list.jhtml" target="iframe">项目类型</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				...
				<dl id="system">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:relationship"]
						<dd>
							<a href="../relationship/list.jhtml" target="iframe">${message("admin.main.relationship")}</a>
						</dd>
					[/@shiro.hasPermission]
