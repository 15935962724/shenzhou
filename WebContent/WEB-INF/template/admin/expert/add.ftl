...
<title>添加专家 - Powered By HaoKangHu</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 添加专家
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
				...
				<td>
					<span class="fieldSet">
						[#list genders as gender]
							<label>
								<input type="radio" name="gender" value="${gender}" />${message("Member.Gender." + gender)}
							</label>
						[/#list]
					</span>
				</td>
			...
			<tr>
				...
				<td>
					<textarea name="advantage" class="" style="width: 46.5%; height: 200px;">
					</textarea>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea id="editor" name="introduce" class="editor"></textarea>
				</td>
			</tr>
			<tr>
				<th>
