...
<body>
        ...
        <form id="listForm" action="doctor_evaluate_list.jhtml" method="get">
            ...
            <td width="280" valign="top">
            	<div class="peo_2">
            		<table cellpadding="0" cellspacing="0" border="0">
            			<tr>
            				<td><img onerror="${base}/resources/mechanism/images/r.png" src="${doctor.logo}" alt="" title="" class="head_1" /></td>
            			</tr>
            			<tr>
                  ...
                  <td height="40">
					<div class="peo_tag_1">
						<ul>
							...
							<li style="width:17%;"><div class="sel_div_1 border_radius_r_1"><a href="${base}/mechanism/doctor/doctor_evaluate_list.jhtml?doctorId=${doctor.id}">评价信息</a></div><div class="div_x_1"></div></li>
						</ul>												
					</div>
               	  </td>
                </tr>
                <tr>
                  <td class="b_l_r_b_dcdcdc_1 p_a_10_1">
