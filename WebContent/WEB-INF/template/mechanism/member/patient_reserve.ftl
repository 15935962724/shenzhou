                  ...
                  <td height="40">
					<div class="peo_tag_1">
						<ul>
                              ...
                              <li style="width:20%;"><div class="sel_div_1"><a href="${base}/mechanism/member/patient_reserve.jhtml?patientMemberId=${patientMember.id}">预约信息</a></div><div class="div_x_1"></div></li>
                ...
                <tr>
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="z_14_323232_1">
					 <form id="inputForm" action="reserve.jhtml" method="get">
