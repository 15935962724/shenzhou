	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="memberRank">性别</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="phone">余额</a>
				</th>
				<th>
			...
			[#list page.content as member]
				<tr>
					...
					<td>
						<span title="${member.createDate?string("yyyy-MM-dd HH:mm:ss")}">${member.birth}</span>
					</td>
					<td>
						${member.phone}
					</td>
					...
					<td>
						${member.area.fullName} ${member.address}
					</td>
					<td>
						<a href="view.jhtml?id=${member.id}">[${message("admin.common.view")}]</a>
						<a href="addassessReport.jhtml?patientMemberId=${member.id}">[添加评估报告]</a>
						[#if !member.parent??]
