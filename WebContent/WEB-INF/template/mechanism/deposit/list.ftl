		...
		<tr>
			...
			<form id="listForm" action="list.jhtml" method="get">
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td class="z20616161 bb1dd4d4d4" height="50">余额统计</td>
					...
					<tr>
						<td class="z14444444">
						余额变动类型：
							<select id="flag" name="type" onchange="$('#listForm').submit();" class="h30 w100 bae1e1e1">
								<option value="">全部状态</option>
								[#list types as typ]
									<option [#if typ==type ]selected="selected"[/#if] value="${typ}">${message("Deposit.Type."+typ)}</option>
								[/#list]
							</select>
						</td>
						...
						<td colspan="2">
							<table cellpadding="0" cellspacing="0" border="0" width="100%" class="">
								<tr class="bg279fff z14ffffff">
									...
									<td class="btle3e3e3" align="center" width="90">变动时间</td>
									<td class="btle3e3e3" align="center" width="90">用户姓名</td>
									<td class="btle3e3e3" align="center" width="200">名下患者</td>
									<td class="btle3e3e3" align="center" width="90">类型</td>
									<td class="btle3e3e3" align="center" width="80">收入</td>
									<td class="btle3e3e3" align="center" width="80">支出</td>
									<td class="btle3e3e3" align="center" width="80">当前余额</td>
									<td class="btle3e3e3" align="center" width="80">订单</td>
								...
								<tr [#if deposit_index%2==0] class="bge7f4ff" [/#if]>
									<td class="btle3e3e3" align="center" height="50">${deposit_index+1}</td>
									<td class="btle3e3e3" align="center">
										${deposit.createDate?string("yyyy-MM-dd")}
										<span class="z12999999">
											${deposit.createDate?string("HH:mm:ss")}
										</span>	
									</td>
									<td class="btle3e3e3 plr10" align="left"> ${deposit.member.name}<br><span class="z12939393"> ${deposit.member.mobile}</span></td>
									<td class="btle3e3e3 plr10" align="left">
									  [#list deposit.member.children as patient]
				                         [#if !patient.isDeleted]
				                         ${patient.name}、
				                         [/#if]
				                      [/#list]
									</td>
									<td class="btle3e3e3" align="center">${message("Deposit.Type." + deposit.type)}</td>
									<td class="btle3e3e3" align="center">${deposit.credit}</td>
									<td class="btle3e3e3" align="center">${deposit.debit}</td>
									<td class="btle3e3e3" align="center">${deposit.balance}</td>
									<td class="btle3e3e3" align="center">[#if deposit.order??]${deposit.order.sn}[#else]-[/#if]</td>
									<td class="btle3e3e3 plr10" align="left">${deposit.memo}</td>
