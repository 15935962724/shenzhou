								...
								<tr>
									...
									<td width="140">
										<select class="z14777777 inputkd9d9d9bgf6f6f6 h30 w100 m1020" id="doctorCategoryId" >
											...
											<option value="${doctorCategory.name}">${doctorCategory.name}</option>
											[/#list]
											<option>其他</option>
										</select>
									</td>
									<td>
										<input type="text" id="name" name="name" class="z14717171 inputkd9d9d9bgf6f6f6 h30 w210 dpn" placeholder="请输入医师职级名称" value="">
									</td>
								</tr>
								<tr>
									...
									<input type="radio" name="chargeType" value="${chargeType}" [#if chargeType_index==0]checked[/#if]  onClick="toggle_ladder();"> ${message("DoctorCategory.ChargeType."+chargeType)}
										&nbsp;　&nbsp;
									[/#list]
									</td>
								</tr>
									...
									<td colspan="3" class="bgf5fafe">
										<table cellpadding="0" cellspacing="0" border="0" width="100%" id="ladder" class="dpn">
											<tr>
												<td width="120"></td>
												<td class="pa10">
													路程在 <input type="text" id="kilometre" name="kilometre" class="z14717171 inputkd9d9d9bgf6f6f6 h30 w40 tac"> 公里内收费 <input type="text" id="price" name="price" class="z14717171 inputkd9d9d9bgf6f6f6 h30 w40 tac"> 元
													<br><br>
													每超过 <input type="text" id="increaseKilometre" name="increaseKilometre" class="z14717171 inputkd9d9d9bgf6f6f6 h30 w40 tac"> 公里增加　 <input type="text" id="increasePrice" name="increasePrice" class="z14717171 inputkd9d9d9bgf6f6f6 h30 w40 tac"> 元
												</td>
											</tr>
										</table>
									</td>
